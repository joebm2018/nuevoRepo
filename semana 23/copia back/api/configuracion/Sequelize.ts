...
import { documentoidentidad_model } from '../modelos/documentoidentidad';
...
export const DocumentoIdentidad:any=documentoidentidad_model(conexion);
...
DocumentoIdentidad.hasMany(Persona,{foreignKey:"doid_id"});
Persona.belongsTo(DocumentoIdentidad,{foreignKey:"doid_id"});
...
//unidad de medida - cotizaciondetalle
Persona.hasMany(Cotizacion,{foreignKey:"per_id"});
Cotizacion.belongsTo(Persona,{foreignKey:"per_id"});
